...
var process = spawnSync('python3', ["./AverageBlockLoading.py", "--A_KB", 0,"--n_KB",0,"--A_SB",0, "--n_SB", 0,null, null,null,null]);
//console.log(process.stdout.toString());
string += (process.stdout.toString())

var process = spawnSync('python3', ["./Capacity.py", "--disp", "50", null, null]);
//console.log(process.stdout.toString());
string += (process.stdout.toString())

var process = spawnSync('python3', ["./DraftAtLanding.py", "--T_m", "14.5", "--Im", "32.5"]);
//console.log(process.stdout.toString());
string += (process.stdout.toString())
