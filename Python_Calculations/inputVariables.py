...
parser.add_argument('--SailAreaArray', dest='SailAreaArray',type =float, help='')
...
parser.add_argument('--LL_a', dest='LL_a',type =float, help='')
parser.add_argument('--LL_f', dest='LL_f',type =float, help='')
parser.add_argument('--m', dest='m',type =float, help='')
parser.add_argument('--T_LD', dest='T_LD',type =float, help='')
